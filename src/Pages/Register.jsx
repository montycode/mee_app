                                ...
                                <Form className="mt-8 space-y-6 ">
                                    <div className="grid grid-cols-2 rounded-md shadow-sm -space-y-px">
                                        <div className="col-span-2 md:col-span-1 p-2 p-4">
                                            ...
                                            <ErrorMessage name="first_name" component="div" className="italic font-bold text-red-500" />
                                        </div>
                                        <div className="col-span-2 md:col-span-1 p-2 p-4">
                                            ...
                                            <ErrorMessage name="last_name" component="div" className="italic font-bold text-red-500" />
                                        </div>
                                        ...
                                        <div className="col-span-2 p-4">
                                            ...
                                            <ErrorMessage name="confirmPassword" component="div" className="italic font-bold text-red-500" />
                                        </div>
                                        {status && status.msg && (
